...
<head>
    ...
    <!-- CDN SweetAlert2 (WAJIB ADA AGAR POP-UP BISA MUNCUL) -->
    ...
    <div class="w-full max-w-md bg-slate-800 text-slate-100 rounded-2xl shadow-2xl border border-slate-700/50 p-8 sm:p-10">
        ...
        <form action="../controller/c_login.php?aksi=proses_login" method="post" class="space-y-6">
            ...
            <div class="pt-2">
                <button
                    type="submit"
                    class="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-lg shadow-lg hover:shadow-indigo-500/30 transition duration-200 active:scale-[0.98]"> Login
                </button>
            </div>
